...
The server must have the LiFx framework installed.
Additionally, ensure that the file art.zip is present on the server side, as it contains required assets for the trade system.
